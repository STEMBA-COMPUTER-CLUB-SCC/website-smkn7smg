...
@section('content')
    <div class="ml-auto mr-auto pl-20 pr-23 flex justify-between">
        <div class="w-max gap-y-28 flex flex-col">
            <div>
                ...
                <p class="font-semibold text-[68px] m-0 mb-6 font-manrope w-[734px]">SEKOLAH MENENGAH KEJURUAN NEGERI 7 SEMARANG</p>
        ...
        <div class="w-max h-max relative">
            <img class="w-[466px] m-0 mb-4" src="/assets/image/image1.png" alt="">
            <div class="flex flex-col absolute bottom-16 right-16 gap-y-2.5">
                <p class="pt-3 pb-3 pl-4 pr-4 rounded-[60px] font-manrope font-medium text-[16px] w-[430px] bg-[#FFFFFF] drop-shadow-lg relative right-14">📗 Peningkatan Literasi dengan Perpustakaan Digital</p>
                <p class="pt-3 pb-3 pl-4 pr-4 rounded-[60px] font-manrope font-medium text-[16px] w-[430px] bg-[#FFFFFF] drop-shadow-lg">🧔 Ketahanan Sekolah dengan Pembentukan Karakter</p>
            </div>
        </div>
    </div>
@endsection
