    ...
    <div class='bg-[#FFFFFF] border border-transparent h-[514px] max-sm:h-[1050px] w-full'>
        <div class='h-[434px] w-[1280px] max-sm:w-screen ml-auto mr-auto mt-[40px]'>
            <div class='flex max-sm:flex-col sm:items-end justify-between mb-14'>
                <div class='w-[524px] max-sm:w-[327px] max-sm:ml-auto max-sm:mr-auto'>
                    <img src="/assets/image/logo-stemba.png" class='w-[76px] mb-8' alt="">
                    <p class='font-inter text-[#111111] font-semibold text-[23px] max-sm:text-[22px] mb-4 w-max'>SMKN 7 SEMARANG</p>
                    <p class='font-manrope text-[20px] max-sm:text-[14px] font-normal text-[#818183] max-w-[524px] max-sm:max-w-[288px] leading-[150%] mb-9'>SMK Negeri 7 Semarang adalah sekolah menengah kejuruan yang berada di Semarang, Jawa Tengah, Indonesia.</p>
                    <div class='border border-[#D9DADB] w-[425px] max-sm:w-[327px] flex justify-between items-center rounded-[16px] h-[60px] max-sm:h-[52px] pl-6 max-sm:pl-5 pr-3 max-sm:pr-2 max-sm:mb-10'>
                ...
                <div class='max-sm:flex-col flex sm:h-max'>
                    <div class="flex sm:h-max gap-x-3 max-sm:gap-x-0 max-sm:mb-3 max-sm:w-max max-sm:ml-auto max-sm:mr-auto">
                        <div class='font-manrope text-[20px] w-[180px] max-sm:w-[159px]'>
                        ...
                        <div class='font-manrope text-[20px] sm:h-[260px] w-[180px] max-sm:w-[159px]'>
                    ...
                    <div class='w-[292px] max-sm:w-[318px] max-sm:gap-y-[110px] sm:h-[266px] max-sm:ml-auto max-sm:mr-auto flex flex-col justify-between'>
            ...
            <hr class="mb-3">
            <p class='w-full max-sm:w-[226px] max-sm:text-[14px] max-sm:ml-auto max-sm:mr-auto font-manrope font-medium text-[16px] border border-b-transparent border-l-transparent border-r-transparent border-t-transparent text-[#6B7280] text-center max-sm:leading-[150%]'>Copyright © 2025 Stemba Computer Club (SCC).</p>
        </div>
    </div>
</section>