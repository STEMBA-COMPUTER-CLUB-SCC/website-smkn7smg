<section id="beranda" class="border border-transparent">
    <div class="ml-auto mr-auto w-max flex gap-x-16.5 mb-20 mt-30">
        <div class="w-max gap-y-[115px] 2xl:gap-y-[200px] flex flex-col">
            <div>
                <div class="sectionBeranda flex bg-[#F7F7F7] text-[16px] m-0 mb-5 font-manrope border border-[#ebebeb] w-max rounded-[80px] items-center pl-1.5 pt-1.5 pb-1.5 pr-4 gap-x-2">
            ...
            <div class="flex items-center">
                <img loading="lazy" draggable="false" class="w-[120px] h-[40px]" src="/assets/icon/Statistic-Container.svg" alt="">
        ...
        <div class="w-max h-max relative">
            <img loading="lazy" draggable="false" class="imageBeranda transition-all duration-300 w-[466px] 2xl:w-[646px] m-0 mb-4" src="/assets/image/image1.png" alt="">
            <div class="welcomeBeranda1 opacity-0 flex flex-col absolute bottom-16 right-16 2xl:right-[78px] gap-y-2.5">
