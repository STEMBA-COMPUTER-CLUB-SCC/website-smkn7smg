<div>
    <div class="flex flex-row w-max ml-auto mr-auto gap-x-[100px] h-max mb-20 mt-20 cs6:gap-x-[0px] cs8:flex-col cs8:gap-y-10 cs5:flex-col cs5:gap-y-10 cs5:w-maxcs5:items-center">
        <div class="mt-5 ">
            ...
            <h1 class="font-manrope text-[48px] font-semibold tracking-[2%] w-[550px] text-[#111111] mb-10 cs5:text-[32px] cs5:w-[327px]"><span class="text-[#1152D9]">HUBUNGI KAMI</span> UNTUK INFORMASI LAINNYA</h1>
            <div class="flex flex-col gap-y-7 mb-10 w-max">
                ...
                <div class="flex flex-row gap-x-3 items-start">
                    ...
                    <div class="font-manrope text-[16px] flex flex-col gap-y-2 cs5:text-[12px]">
                        ...
                        <p class="text-[#111111] w-[372px] cs5:w-[238px]">Jalan Simpang Lima, RT 02 RW 01, Kel. Mugassari, Kec. Semarang Selatan, Kota Semarang, 50249</p>
                    </div>
                </div>
            </div>
        ...
        <div class="p-10 rounded-[24px] bg-[#F7FAFF] w-[630px] cs7:w-[460px] cs5:w-[327px]">
            <form method="POST" id="formKontak" class="flex flex-col gap-y-7" action="{{ url('/kontak') }}">
                ...
                <div class="flex flex-col gap-y-3">
                    ...
                    <div class="bg-[#ffffff] border border-[#EBEBEB] focus-within:border-[#1152D9] transition-all duration-300 ease-in-out w-[550px] h-[48px] rounded-[16px] flex flex-row items-center gap-x-4 pl-5 cs7:w-full cs5:w-[250px]">
                        <img src="/assets/icon/user.png" class="size-[20px] cs5:size-[16px]" alt="">
                        <input type="text" placeholder="Masukkan nama lengkap" name="name" id="" class="text-[#727272] text-[16px] w-[470px] focus:outline-none focus:border-none cs7:w-full cs5:text-[12px] cs5:w-full">
                    </div>
                </div>
                <div class="flex flex-col gap-y-3">
                    ...
                    <div class="bg-[#ffffff] border border-[#EBEBEB] focus-within:border-[#1152D9] transition-all duration-300 ease-in-out w-[550px] h-[48px] rounded-[16px] flex flex-row items-center gap-x-4 pl-5 cs7:w-full cs5:w-[250px]">
                        ...
                        <input type="email" placeholder="Masukkan email" name="email" id="" class="text-[#727272] text-[16px] w-[470px] focus:outline-none focus:border-none cs7:w-full cs5:text-[12px] cs5:w-full">
                    </div>
                </div>
                <div class="flex flex-col gap-y-3 ">
                    ...
                    <div class="flex flex-row justify-between cs5:w-[287px]">
                        <div class="relative">
                            <div wire:click="toggleDropdown"
                                ...
                                <div class="bg-[url({{ $selectedFlag }})] size-[30px] cs5:size-[24px] rounded-full bg-cover bg-center border border-[#EBEBEB] flag"></div>
                                <img id="arrow-icon" loading="lazy" draggable="false" src="/assets/icon/arrow-down.svg" alt="" class="w-[20px] cs5:w-[16px] transition-transform duration-300 ease-in-out {{ $isDropdownOpen ? 'rotate-180' : '' }}">
                            </div>
                        ...
                        <div class="bg-[#ffffff] w-[444px] h-[48px] rounded-[16px] flex flex-row items-center gap-x-4 pl-5 border border-[#EBEBEB] focus-within:border-[#1152D9] transition-all duration-300 ease-in-out cs7:w-[280px] cs5:w-full">
                            <p class="font-semibold font-manrope text-[#727272]">{{ $selectedCountryCode }}</p>
                            <input wire:model.live="phoneNumber" type="number" placeholder="Masukkan nomor telepon" id="phoneNumber" class="text-[#727272] text-[16px] w-[350px] focus:outline-none focus:border-none cs7:w-full cs5:text-[12px] cs5:w-full">
                ...
                <div class="flex flex-col gap-y-3 mb-3">
                    ...
                    <div class="relative focus-within:border rounded-lg w-full">
                        ...
                        <div id="charCount" class="absolute flex flex-row w-[525px] justify-between bottom-3 left-3 text-gray-500 text-sm pointer-events-none items-center">
                            ...
                            <img src="/assets/icon/resize.png" draggable="false" class=" size-[20px] pointer-events-auto cursor-nwse-resize relative cs7:-translate-x-[170px] cs5:-translate-x-[300px]" alt="">
                        </div>
                    </div>
                </div>
