        ...
        <div class="w-[616px]">
            ...
            <div class='flex flex-col gap-y-3 mb-11'>
                <div class='flex items-center gap-x-2'>
                    <img src="/assets/icon/tick-circle.svg" class='size-[24px]' alt="">
            ...
            <a href="">
                <p class="font-manrope font-semibold text-base text-white bg-[#1152D9] w-max py-2.5 px-8 rounded-[42px] text-[16px]">Selengkapnya</p>
            </a>
        </div>
    </div>
    <div class='w-max flex flex-row-reverse font-manrope h-[440px] gap-x-14 ml-auto mr-auto mb-20'>
        <img src="/assets/image/jurusan2.png" class='w-[608px] h-[440px]' alt="">
        <div class="w-[616px]">
