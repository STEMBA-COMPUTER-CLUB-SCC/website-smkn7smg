<section id="tentang" class="border border-transparent pt-28">
    <div class="flex flex-col gap-y-10 max-sm:gap-y-8 w-max ml-auto mr-auto max-sm:mb-10 mb-14 2xl:mb-[76px]">
        <div id="judulTentang" 
    ...
    <div class="flex max-sm:flex-col max-sm:gap-y-5 w-max gap-x-7 2xl:gap-x-8 ml-auto mr-auto mb-20 max-sm:mb-10 2xl:mb-25">
        <div class="cardMasjidTentang opacity-0 bg-[url(/assets/image/masjid.png)] w-[404px] max-sm:w-[327px] max-sm:h-[404px] 2xl:w-[535px] h-[496px] 2xl:h-[651px] max-sm:rouneded-[24px] bg-cover relative">
