<div class="w-screen h-[calc(100vh-96px)] bg-[url(/assets/image/background-404.png)] flex items-center justify-center bg-center bg-cover">
    <div class="flex flex-col items-center">
        ...
        <a href="/">
            <p class="text-[#FFFFFF] transition-all duration-300 text-[16px] font-manrope font-semibold bg-[#1152D9] hover:bg-[#007FFF] py-2.5 px-8 rounded-[42px]">Kembali ke beranda</p>
        </a>
    </div>
</div>