<div id='prestasi' class='flex flex-row cs5:flex-col cs5:gap-y-20 cs5:w-full w-[1280px] h-max mt-20 cs5:mt-[110px] mb-20 justify-between ml-auto mr-auto cs6:w-[1140px] cs7:flex-col cs7:w-max cs7:gap-y-20'>    
